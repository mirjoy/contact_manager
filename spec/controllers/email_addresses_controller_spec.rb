...
RSpec.describe EmailAddressesController, type: :controller do
  let(:valid_attributes) {
    {email: 'email@email.com', contact_id: 1, contact_type: 'Person'}
  }
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      let(:valid_attributes) {{email: 'alice@email.com', contact_id: alice.id, contact_type: 'Person'}}
      ...
      it "redirects to the email_address's person" do
        ...
        valid_attributes = {email: 'alice@email.com', contact_id: alice.id, contact_type: 'Person'}
        post :create, {:email_address => valid_attributes}, valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      let(:new_attributes) {{email: 'email2@email.com', contact_id: bob.id, contact_type: 'Person'}}
      ...
      it "updates the requested email_address" do
        ...
        expect(email_address.email).to eq('email2@email.com')
